...
trait DriverAttributeTrait
{
    ...
    public function active_driver_subscription()
    {
        return $this->hasOne('App\Models\DriverSubscriptionHistory', 'driver_id', 'id')->active()->latest();
    }

    public function hasActiveDriverSubscription()
    {
        return $this->active_driver_subscription()->exists();
    }

    public function current_location()
    {
        return $this->hasOne('App\Models\DriverLocation', 'driver_id', 'id');
    }
}
