...
class FinanceSettingsLivewire extends BaseLivewireComponent
{
    ...
    public function mount()
    {
        ...
        $this->enableDriverSubscription = (bool) setting('finance.enableDriverSubscription', false);
        $this->driverWalletRequired = (bool) setting('driverWalletRequired');
        $this->vendorUseSubscriptionDefault = (bool) setting('vendorUseSubscriptionDefault');
    ...
    public function saveAppSettings()
    {
        ...
        try {
            ...
            $appSettings = [
                ...
                'vendorUseSubscriptionDefault' =>  $this->vendorUseSubscriptionDefault,
                'finance' => [
                    'allowWallet' =>  $this->allowWallet,
                    'allowWalletTransfer' =>  $this->allowWalletTransfer,
                    'enableDriverSubscription' =>  $this->enableDriverSubscription,
