...
class Notification extends BaseSettingsComponent
{
    ...
    public function notificationSetting()
    {
        ...
        $this->firestoreDatabase = setting('firestoreDatabase', '(default)');
        $this->firestoreRelatedPrefix = setting('firestoreRelatedPrefix', '');
    }
    ...
    public function saveNotificationSetting()
    {
        ...
        try {
            ...
            $firebaseSettingsArray = [
                ...
                "firestoreDatabase" => $this->firestoreDatabase ?? "(default)",
                "firestoreRelatedPrefix" => $this->firestoreRelatedPrefix,
            ];
            ...
            if ($this->photo != null) {
                ...
                $firebaseSettingsArray['serviceKeyPath'] = $serviceKeyPath ?? "";
            }


            setting($firebaseSettingsArray)->save();
