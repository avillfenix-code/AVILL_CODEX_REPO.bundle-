    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            ...
            "strings" => [
                ...
                "enableDriverSubscription" => (bool) setting('finance.enableDriverSubscription', false),
                ...
                "dynamic_link" => [
                    ...
                    "scheme" => env('dynamic_link.scheme'),
                ...
                //firebase
                "firebase" => [
                    "prefix" => setting('firestoreRelatedPrefix', ''),
                    "db" => setting('firestoreDatabase', '(default)'),
                ],
            ],
