...
class SyncDemoData extends Command
{
     ...
     * @var string
     */
    protected $description = 'Reset and reseed the curated demo data set';
    ...
    public function handle()
    {
        ...
        $seeders = [
            ...
            //
            'AmenitySeeder',
            'CancellationPolicySeeder',
            'PropertyTypeSeeder',
            'PropertySeeder',
            'BookingFeeTypeSeeder',
            'BookingOrderSeeder',
            'PropertyReportReasonSeeder',
            'PropertyReviewSeeder',
            'SubscriptionSeeder',
        ];
        ...
        //clear missing mdia
        $this->info("Cleaning up missing media");
        Artisan::call("clean:media");
        $this->info("Cleaning up missing media completed");
    }
