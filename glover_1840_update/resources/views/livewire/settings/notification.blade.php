<div>
    <x-form action="saveNotificationSetting" :noClass="true">
        <div class="w-full md:w-8/12 lg:w-6/12 space-y-6">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <x-input title="App ID" name="appId" />
                <x-input title="API Key" name="apiKey" />
                <x-input title="Project ID" name="projectId" />
                {{-- --}}
                <x-input title="Firestore Database" name="firestoreDatabase" placeholder="(default)" />
                <x-input title="Firestore Related Prefix" name="firestoreRelatedPrefix" placeholder="prod_" />
