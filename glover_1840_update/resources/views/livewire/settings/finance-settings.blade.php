            ...
            <div class="">
                ...
                <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div class="block mt-4 text-sm">
                        ...
                        <x-checkbox title="{{ __('Enable') }}" description="" name="driverSelfPay" />
                    ...
                    <div class="block mt-4 text-sm">
                        ...
                        <x-checkbox title="{{ __('Enable') }}" name="vendorSetDeliveryFee" />
                    </div>
                    <div class="block mt-4 text-sm">
                        <p>{{ __('New Vendor - Use Subscription') }}</p>
                        <x-checkbox title="{{ __('Enable') }}" name="vendorUseSubscriptionDefault" />
                    </div>
                    <div class="block mt-4 text-sm">
                ...
                <div class='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <x-checkbox title="{{ __('Reward on regirstration') }}"
                        ...
                        name="enableOnRegistrationReferReward" />
                ...
                <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 '>
                    ...
                    <div class="block p-2 mt-4 text-sm border rounded">
                        <p>{{ __('Driver Subscription System') }}</p>
                        <x-checkbox title="{{ __('Enable') }}" name="enableDriverSubscription" />
                        <p class="py-2 text-xs font-light"><span
                                class="pr-2 text-sm font-medium text-red-600">Note:</span>{{ __('When enabled, drivers need an active subscription to go online and receive new order assignments') }}
                        </p>
                    </div>
                    ...
                    <div class="block mt-4 text-sm">
                        ...
                        <x-checkbox title="{{ __('Enable') }}" name="collectDeliveryCash" />
                        <p class="py-2 text-xs font-light"><span
                ...
                <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div class="block mt-4 text-sm">
                        ...
                        <x-checkbox title="{{ __('Enable') }}"
                            description="{{ __('Allow wallet transfer between users') }}"
                            name="allowWalletTransfer" />
                    </div>
