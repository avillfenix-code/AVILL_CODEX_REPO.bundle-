        ...
        <x-form action="saveSettings">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 w-full">
                <div class="">
                    ...
                    <x-select title="{{ __('Request Booking Code') }}" name="requestBookingCode"
            ...
            <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 '>
                ...
                <x-input title="{{ __('Delay same order subsequent Search') }}({{ __('Seconds') }})"
                    name="delayResearchTaxiMatching" type="number" min="{{ (int)(setting('alertDuration', 5)) * 2 }}" step="1"/>
                    <p class="my-2 text-xs italic text-gray-500">
                        {{ __("Current new order alert notification duration:") }} 
                       {{ setting('alertDuration', 5) }}{{ __('seconds.') }}
                    </p>
                    </div>
            </div>
