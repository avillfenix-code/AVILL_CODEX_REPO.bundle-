<ul class="mt-6">
    ...
    <!-- manager vendor details -->
    @if(amI('manager'))
        <x-menu-item title="{{ __('Business Details') }}" route="my.business.details">
            <x-tabler-building-store class="w-5 h-5" />
        </x-menu-item>
    @endif
    ...
    @showPropertyBooking
    <x-group-menu-item routePath="property*" title="{{ __('Property Booking') }}" icon="heroicon-o-office-building">
        @can('manage-properties')
            <x-menu-item title="{{ __('Properties') }}" route="properties">
                <x-heroicon-o-office-building class="w-5 h-5" />
            </x-menu-item>
        @endcan

        @can('manage-amenities')
            <x-menu-item title="{{ __('Amenities') }}" route="amenities">
                <x-heroicon-o-star class="w-5 h-5" />
            </x-menu-item>
        @endcan

        @can('manage-property-types')
            <x-menu-item title="{{ __('Property Types') }}" route="property.types">
                <x-heroicon-o-collection class="w-5 h-5" />
            </x-menu-item>
        @endcan

        @can('manage-cancellation-policies')
            <x-menu-item title="{{ __('Cancellation Policies') }}" route="cancellation.policies">
                <x-heroicon-o-shield-exclamation class="w-5 h-5" />
            </x-menu-item>
        @endcan

        @can('manage-booking-fee-types')
            <x-menu-item title="{{ __('Booking Fee Types') }}" route="booking.fee.types">
                <x-heroicon-o-currency-dollar class="w-5 h-5" />
            </x-menu-item>
        @endcan
        ...
        @can('manage-property-report-reasons')
            <x-menu-item title="{{ __('Property Report Reasons') }}" route="property.report.reasons">
                <x-heroicon-o-flag class="w-5 h-5" />
            </x-menu-item>
        @endcan
        @can('manage-property-reports')
            <x-menu-item title="{{ __('Property Reports') }}" route="property.reports">
                <x-heroicon-o-flag class="w-5 h-5" />
            </x-menu-item>
        @endcan
    ...
    <x-group-menu-item routePath="order/*" title="{{ __('Orders') }}" icon="heroicon-o-shopping-bag">
        ...
        @endshowTaxiOrders
        @showPropertyOrders
        <x-menu-item title="{{ __('Booking Orders') }}" route="orders.booking">
    ...
    @canany(['view-subscription', 'manage-driver-subscriptions'])
        <x-group-menu-item routePath="subscription*" title="{{ __('Subscription') }}" icon="heroicon-o-shield-check">
            ...
            @endhasanyrole
            @can('manage-driver-subscriptions')
                <x-menu-item title="{{ __('Driver Subscriptions') }}" route="drivers.subscriptions">
                    <x-heroicon-o-truck class="w-5 h-5" />
                </x-menu-item>
            @endcan
    ...
    @can('view-operations')
        ...
        <x-group-menu-item routePath="operations/*" title="{{ __('Operations') }}" icon="heroicon-o-server">
            ...
            @can('view-activity-logs')
                <x-menu-item title="{{ __('Activity Logs') }}" route="activity.logs">
    ...
    @can('view-settings')
        <x-group-menu-item routePath="setting/*" title="{{ __('Settings') }}" icon="heroicon-o-cog">
            ...
            <x-menu-item title="{{ __('WebSocket Monitor') }}" route="settings.websocket.monitor">
                <x-heroicon-o-status-online class="w-5 h-5" />
            </x-menu-item>

            @can('manage-notification-settings')
                <x-menu-item title="{{ __('Backend Notification') }}" route="notification.settings">
                    <x-tabler-notification class="w-5 h-5" />
                </x-menu-item>
            @endcan
            ...
            @can('manage-api-security')
                <x-menu-item title="{{ __('API Security') }}" route="settings.api.security">
            ...
            @can('edit-system-translations')
                <x-menu-item title="{{ __('Translation Editor') }}" route="translation.editor">
    ...
    {{-- misc --}}
    @canany(['mang-onboarding', 'view-faq'])
    ...
    <x-group-menu-item routePath="reports/*" title="{{ __('Reports') }}" icon="heroicon-o-chart-square-bar">
        ...
        @endshowService
        @showPropertyBooking
        <x-menu-item title="{{ __('Properties') }}" route="reports.properties">
            <x-heroicon-o-home class="w-5 h-5" />
        </x-menu-item>
        @endshowPropertyBooking
        ...
        @endcan
        @can('manage-driver-subscriptions')
            <x-menu-item title="{{ __('Driver Subscriptions') }}" route="reports.driver.subscriptions">
                <x-heroicon-o-truck class="w-5 h-5" />
            </x-menu-item>
        @endcan
    ...
    @can('view-avill-fares')
        <x-group-menu-item routePath="avill/*" title="{{ __('AVILL Quibdó') }}" icon="tabler-map-pin">

            @can('view-avill-fares')
                <x-menu-item title="{{ __('Tarifas Quibdó') }}" route="avill.fares">
                    <x-heroicon-o-currency-dollar class="w-5 h-5" />
                </x-menu-item>
            @endcan

            @can('view-avill-areas')
                <x-menu-item title="{{ __('Zonas AVILL') }}" route="avill.areas">
                    <x-heroicon-o-map class="w-5 h-5" />
                </x-menu-item>
            @endcan

            @can('view-avill-surcharges')
                <x-menu-item title="{{ __('Recargos') }}" route="avill.surcharges">
                    <x-heroicon-o-plus-circle class="w-5 h-5" />
                </x-menu-item>
            @endcan

            @can('view-avill-holidays')
                <x-menu-item title="{{ __('Festivos') }}" route="avill.holidays">
                    <x-heroicon-o-calendar class="w-5 h-5" />
                </x-menu-item>
            @endcan
