                  ...
                  child:
                      VStack([
                        ...
                        VStack([
                            ...
                            child: orderSection(
                              VStack([
                                HStack([
                                  //
                                  VStack([
                                    "Domiciliario".tr().text.gray500.medium.sm.make(),
                          ...
                          orderSection(
                            VStack([
                              HStack([
                                //
                                VStack([
                                  "Cliente".tr().text.gray500.medium.sm.make(),
                          ...
                          orderSection(
                            VStack([
                              "Nota".tr().text.gray500.medium.sm.make(),
                              (vm.order.note).text.medium.xl.italic.make().expand(),
                            ]),
                            context,
                          ),
                    ...
                    child:
                        VStack([
                          ...
                          "Pago pendiente"
                              ...
                              .makeCentered(),
                          4.heightBox,
                          "Hasta que se confirme el pago, este pedido no debe procesarse."
                              .tr()
                              .text
                              .color(Colors.white)
                              .lg
